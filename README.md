...
# Project 3 - *ios_yelp_swift*

**ios_yelp_swift** is a Yelp search app using the [Yelp API](http://www.yelp.com/developers/documentation/v2/search_api).
...
<img src='https://raw.githubusercontent.com/ingdjason/ios_yelp_swift/master/YELP-DEMO.gif' title='Video YELP' width='' alt='Video YELP' />
